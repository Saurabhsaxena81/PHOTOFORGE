...
export default function GetStarted({ theme }) {
  ...
  return (
    <section
      className={`py-8 sm:py-12 md:py-16 rounded-3xl mx-auto my-6  md:my-12 lg:my-20 xl:my-28 max-w-[1170px]  ${
        theme === "dark"
    ...
    >
      <div className="container mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl md:text-4xl text-center  mb-4 md:mb-6 font-extrabold">
          Ready to <span className="text-yellow-400">remove</span> the
          <br /> <span className="text-yellow-400">background</span> of your
          image?
        </h2>
